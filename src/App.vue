                ...
                <div v-if="!isLocaleCN || !isMiniApp">
                    ...
                    <ul>
                        <li>This project is open sourced at <a
                                href="https://github.com/rishabh264/COVID-19-Timeline">Github Repository</a>,
                            pull requests and issues welcomed!
                        </li>
                        <li>© 2020 <a
                                href="https://github.com/rishabh0264">@rishabh0264</a>
                            <span>{{isLocaleCN ? " | UCLCSSA 伦敦大学学院中国学联" : " "}}</span>
                        </li>
                    </ul>
                        <div style="font-size:14px; opacity:0.5;">You are free to distribute, embed or edit whole or part of the site without prior notice to us, as long as
                            you mention the source  or keep this section intact. Please see the github repo for more
